...
<html>
    ...
    <body>
        ...
        <c:choose>
            <c:when test="${not empty listOfProducts}">
                <div class="container">
                ...
                <c:set var="paging" value="${requestScope.PAGING}"></c:set>
                    ...
                    <nav aria-label="Page navigation" class="set-left-margin">
                        ...
                        <c:if test="${param.txtPage ne 1}">
                            <li class="page-item">
                                <a class="page-link" href="ViewFull?txtSearchValue=${param.txtSearchValue}&txtPage=${param.txtPage - 1}&txtLowerPrice=${param.txtLowerPrice}&txtUpperPrice=${param.txtUpperPrice}&cbCategory=${param.cbCategory}">
                                    Previous
                                </a>
                            </li>
                        </c:if>
                        <c:if test="${param.txtPage eq 1}">
                            <li class="page-item">
                                <a class="page-link disabled" href="storefull.jsp">
                                    Previous
                                </a>
                            </li>
                        </c:if>    
                        ...
                        <c:forEach var="thisPage" begin="1" end="${paging}" varStatus="counter">
                            <li class="page-item">
                                <c:if test="${param.txtPage ne counter.count}">
                                    <a class="page-link" href="ViewFull?txtSearchValue=${param.txtSearchValue}&txtPage=${counter.count}&txtLowerPrice=${param.txtLowerPrice}&txtUpperPrice=${param.txtUpperPrice}&cbCategory=${param.cbCategory}">
                                        ${counter.count}
                                    </a>
                                </c:if>
                                <c:if test="${param.txtPage eq counter.count}">
                                    <a href="storefull.jsp" class="page-link disabled">${counter.count}</a>
                                </c:if>
                            </li>
                        </c:forEach>
            ...
            <c:otherwise>
                <p class="alert alert-danger">Not found any result!</p>
            </c:otherwise>
        </c:choose>
