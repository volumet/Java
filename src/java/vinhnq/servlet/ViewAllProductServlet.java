...
public class ViewAllProductServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            productDAO.loadAllProducts(productPerPage, today);
            ...
            logger.error("ViewAllProductServlet NamingException " + e.getMessage());
        } catch (SQLException e) {
            logger.error("ViewAllProductServlet SQLException " + e.getMessage());
        } finally {
