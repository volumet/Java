...
public class GoogleIdTokenVerifier extends IdTokenVerifier {
     ...
     *
     * <p>
     * Upgrade warning: in prior version 1.16 it may return {@code null} and not
     * throw any exceptions, but starting with version 1.17 it cannot return
     * {@code null} and may throw {@link GeneralSecurityException} or
     * {@link IOException}.
     * </p>
     *
     * @deprecated (scheduled to be removed in 1.18) Use
     ...
     * {@link Clock#currentTimeMillis()} or {@code 0} for none.
     *
     * @deprecated (scheduled to be removed in 1.18) Use
     * {@link #getPublicKeysManager()} and
     ...
     *
     * <ul>
     * <li>The RS256 signature, which uses RSA and SHA-256 based on the public
     * keys downloaded from the public certificate endpoint.</li>
     * <li>The current time against the issued at and expiration time (allowing
     * for a 5 minute clock skew).</li>
     * <li>The issuer is {@code "accounts.google.com"} or
     * {@code "https://accounts.google.com"}.</li>
     * </ul>
     *
     ...
     * {@link #verify(GoogleIdToken)} and returns the ID token if succeeded.
     *
     * @param idTokenString Google ID token string
     * @return Google ID token if verified successfully or {@code null} if
     * failed
     * @since 1.9
     */
     ...
     *
     * <p>
     * This method is automatically called if the public keys have not yet been
     * initialized or if the expiration time is very close, so normally this
     * doesn't need to be called. Only call this method explicitly to force the
     * public keys to be updated.
     * </p>
     *
     * @deprecated (scheduled to be removed in 1.18) Use
     * {@link #getPublicKeysManager()} and
    ...
    public static class Builder extends IdTokenVerifier.Builder {
         ...
         * {@link GoogleOAuthConstants#DEFAULT_PUBLIC_CERTS_ENCODED_URL}.
         * </p>
         *
         * <p>
         ...
         * @since 1.15
         * @deprecated (scheduled to be removed in 1.18) Use
         * {@link GooglePublicKeysManager.Builder#setPublicCertsEncodedUrl(String)}
         * instead.
         */
        @Deprecated
